...
| `devcontrol/src/kaliv_dev_control/__init__.py` | 4873 | 183 | 0 | 0 | 17 | — |
| `devcontrol/src/kaliv_dev_control/bounded_subprocess.py` | 17710 | 528 | 4 | 7 | 1 | hashing, path_validation |
| `devcontrol/src/kaliv_dev_control/campaign.py` | 11018 | 326 | 4 | 2 | 1 | canonicalization, hashing |
| `devcontrol/src/kaliv_dev_control/catalog.py` | 17419 | 476 | 13 | 5 | 2 | canonicalization, hashing, path_validation |
| `devcontrol/src/kaliv_dev_control/commands.py` | 10421 | 318 | 6 | 1 | 2 | canonicalization, hashing, path_validation |
| `devcontrol/src/kaliv_dev_control/contract.py` | 9839 | 277 | 5 | 4 | 0 | canonicalization, path_validation |
| `devcontrol/src/kaliv_dev_control/durable_publication.py` | 10282 | 295 | 1 | 12 | 0 | path_validation, publication |
| `devcontrol/src/kaliv_dev_control/evidence.py` | 1890 | 67 | 1 | 1 | 2 | canonicalization, hashing |
| `devcontrol/src/kaliv_dev_control/files.py` | 5466 | 157 | 3 | 0 | 1 | path_validation |
| `devcontrol/src/kaliv_dev_control/github_read.py` | 15848 | 413 | 7 | 0 | 1 | canonicalization, hashing, publication |
| `devcontrol/src/kaliv_dev_control/patch.py` | 11372 | 358 | 4 | 0 | 4 | canonicalization, hashing, path_validation, publication |
| `devcontrol/src/kaliv_dev_control/physical_isolation.py` | 25202 | 607 | 7 | 9 | 2 | canonicalization, hashing, path_validation, publication |
...
| `devcontrol/src/kaliv_dev_control/runtime_staging.py` | 22730 | 602 | 3 | 12 | 5 | canonicalization, hashing, path_validation, publication |
| `devcontrol/src/kaliv_dev_control/streaming_publication.py` | 3631 | 111 | 1 | 1 | 1 | hashing, path_validation, publication |
| `devcontrol/src/kaliv_dev_control/_runtime_closure_common.py` | 9108 | 277 | 1 | 16 | 3 | canonicalization, hashing, path_validation, publication |
...
| `devcontrol/src/kaliv_dev_control/tier_a_authority.py` | 7995 | 195 | 0 | 8 | 3 | canonicalization, hashing, path_validation |
...
| `devcontrol/src/kaliv_dev_control/_tier_a_materialization.py` | 4476 | 134 | 3 | 0 | 5 | path_validation |
| `devcontrol/src/kaliv_dev_control/_tier_a_legacy_toolhost.py` | 1795 | 48 | 0 | 1 | 2 | canonicalization, hashing, path_validation |
| `devcontrol/src/kaliv_dev_control/_tier_a_legacy_plan.py` | 11218 | 284 | 1 | 1 | 7 | canonicalization, path_validation |
| `devcontrol/src/kaliv_dev_control/_tier_a_legacy_runner.py` | 5706 | 163 | 0 | 2 | 12 | canonicalization, path_validation |
| `devcontrol/src/kaliv_dev_control/_tier_a_execution_core.py` | 1233 | 48 | 0 | 0 | 7 | canonicalization, path_validation |
...
| `devcontrol/src/kaliv_dev_control/workspace.py` | 6826 | 206 | 5 | 0 | 3 | path_validation |
