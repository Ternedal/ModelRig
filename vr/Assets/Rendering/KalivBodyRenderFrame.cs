...
{
    [Serializable]
    public sealed class KalivVisemeWeight
    {
        public string id;
        public float weight;
    }
    ...
    [Serializable]
    public sealed class KalivFaceChannel
    {
        public string id;
        public float value;
    }
    ...
    [Serializable]
    public sealed class KalivFaceChannelSource
    {
        public string id;
    ...
    [Serializable]
    public sealed class KalivOptionalFrequency
    {
        public bool present;
        public float value;
    }
    ...
    [Serializable]
    public sealed class KalivBodyRenderFrame
    {
        public string type;
        ...
        public KalivVisemeWeight[] visemes;
        ...
        public KalivFaceChannel[] face_channels;
        public KalivFaceChannelSource[] face_channel_sources;
        ...
        public KalivOptionalFrequency gesture_frequency_per_minute;
        ...
        public static KalivBodyRenderFrame Parse(string json)
        {
            ...
            try
            {
                frame = JsonUtility.FromJson<KalivBodyRenderFrame>(json);
            }
            catch (Exception exc)
            {
    ...
    [Serializable]
    public sealed class KalivRenderFrameSequence
    {
        public KalivBodyRenderFrame[] frames;
    }
}
