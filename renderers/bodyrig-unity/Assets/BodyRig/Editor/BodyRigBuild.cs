...
namespace ModelRig.BodyRig.UnityRenderer.Editor
{
    public static class BodyRigBuild
    {
        ...
        /// <summary>
        /// Fail closed unless every shader UniVRM loads by name is already in
        /// the committed Always Included Shaders list. A physical proof must
        /// never repair or reserialize repository settings as part of the run.
        /// </summary>
