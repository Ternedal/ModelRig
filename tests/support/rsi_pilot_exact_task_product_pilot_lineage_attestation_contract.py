...
def _build_fixture():
    ...
    execution = _find_exact(
        bundle,
        execution_admission.PilotExactTaskExecutionAdmissionReceipt,
    )
    if execution is None:
        raise AssertionError("ADR-DC-084 fixture lost ADR-DC-033 lineage")
    ...
    execution_root = _find_ledger_root(
        bundle, f"{execution.admission_key_sha256}.json"
    )
