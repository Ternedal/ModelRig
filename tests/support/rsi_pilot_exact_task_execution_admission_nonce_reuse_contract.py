...
def run_contract() -> None:
    ...
    # ADR-DC-054 binds that verified remote candidate into inert, exact draft-PR
    # creation requirements. Human PR authority and all GitHub API writes remain later.
