...
from rsi_pilot_runtime_preflight_binding_contract import (  # noqa: E402
    run_contract as run_runtime_preflight_binding_contract,
)
...
def run_contract() -> None:
    ...
    run_runtime_preflight_binding_contract()
