"""Locked Stage-B wrapper for ADR-DC-067 through ADR-DC-099 product-pilot pre-start qualification.
...
_CONTRACT_FILES = (
    ...
    "rsi_pilot_exact_task_product_pilot_start_qualified_readiness_contract.py",
)
