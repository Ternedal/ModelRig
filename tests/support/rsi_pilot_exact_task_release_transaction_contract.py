...
def run_contract() -> None:
    ...
    from rsi_pilot_exact_task_staging_completion_readiness_contract import (
        run_contract as run_staging_completion_readiness_contract,
    )

    run_staging_completion_readiness_contract()
    from rsi_pilot_exact_task_production_deployment_plan_contract import (
        run_contract as run_production_deployment_plan_contract,
    )

    run_production_deployment_plan_contract()
    from rsi_pilot_exact_task_production_deployment_state_observation_contract import (
        run_contract as run_production_deployment_state_observation_contract,
    )

    run_production_deployment_state_observation_contract()
