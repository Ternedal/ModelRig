"""Locked Stage-B wrapper for ADR-DC-067 through ADR-DC-096."""
...
def run_contract() -> None:
    ...
    from rsi_pilot_exact_task_product_pilot_start_requirements_contract import (
        run_contract as run_product_pilot_start_requirements_contract,
    )

    run_product_pilot_start_requirements_contract()
