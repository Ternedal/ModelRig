...
def run_contract() -> None:
    ...
    from rsi_pilot_exact_task_post_staging_success_status_attestation_contract import (
        run_contract as run_post_staging_success_status_attestation_contract,
    )

    run_post_staging_success_status_attestation_contract()
    from rsi_pilot_exact_task_production_activation_readiness_contract import (
        run_contract as run_production_activation_readiness_contract,
    )

    run_production_activation_readiness_contract()
    from rsi_pilot_exact_task_production_activation_authorization_contract import (
        run_contract as run_production_activation_authorization_contract,
    )

    run_production_activation_authorization_contract()
    from rsi_pilot_exact_task_production_activation_transaction_contract import (
        run_contract as run_production_activation_transaction_contract,
    )

    run_production_activation_transaction_contract()
    from rsi_pilot_exact_task_production_activation_recovery_contract import (
        run_contract as run_production_activation_recovery_contract,
    )

    run_production_activation_recovery_contract()
    from rsi_pilot_exact_task_post_production_activation_attestation_contract import (
        run_contract as run_post_production_activation_attestation_contract,
    )

    run_post_production_activation_attestation_contract()
    from rsi_pilot_exact_task_product_pilot_start_readiness_contract import (
        run_contract as run_product_pilot_start_readiness_contract,
    )

    run_product_pilot_start_readiness_contract()
    from rsi_pilot_exact_task_product_pilot_start_authorization_contract import (
        run_contract as run_product_pilot_start_authorization_contract,
    )

    run_product_pilot_start_authorization_contract()
