"""Stage-B driver for ADR-DC-095 with shared normal readiness provenance.

The canonical post-production attestation contract remains independently
runnable. Stage-B reuses only the expensive immutable ADR-DC-091 normal-readiness
chain. Every adversarial case still creates fresh ADR-DC-092 authorization,
ADR-DC-093 transaction state/filesystem, and ADR-DC-094 recovery state.
"""
from __future__ import annotations

import os

import rsi_pilot_exact_task_post_production_activation_attestation_contract as contract
