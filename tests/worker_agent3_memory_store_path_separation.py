...
# repository's generated top-level test inventory does not change merely to
# exercise one implementation slice.
run_support(
    "W02-B",
...
run_support(
    "W03-A completed-turn persistence",
    "worker_memory4_completed_turn_persistence.py",
)
