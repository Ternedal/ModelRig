#!/usr/bin/env python3
"""Run the retained Agent 3 pilot contract against candidate 1.58.149."""
...
check(module.BRANCH == "agent/unified-candidate-1.58.149", "operator is pinned to the combined physical branch")
check(module.VERSION == "1.58.149", "operator is pinned to version 1.58.149")
sha = "a" * 40
