#!/usr/bin/env python3
"""Run the retained Agent 3 pilot contract against candidate 2.0.12."""
...
check(module.BRANCH == "physical-proof/2.0.12", "operator is pinned to the combined physical branch")
check(module.VERSION == "2.0.12", "operator is pinned to version 2.0.12")
sha = "a" * 40
