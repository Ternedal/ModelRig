...
check(set(names) == {"rig_status", "note_append", "list_models", "current_datetime", "list_documents", "delete_model", "pull_model", "job_status", "cancel_job"},
      "T12: enabled tools advertised")
g.disabled_tools.add("note_append")
names = [t["function"]["name"] for t in T.ollama_tool_schema(g)]
check("note_append" not in names and set(names) == {"rig_status", "list_models", "current_datetime", "list_documents", "delete_model", "pull_model", "job_status", "cancel_job"},
