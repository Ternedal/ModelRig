...
policy = code_of(root / "android/app/src/main/java/dk/ternedal/modelrig/logic/Agent3TaskUiPolicy.kt")
screen = code_of(root / "android/app/src/main/java/dk/ternedal/modelrig/ui/Agent3TaskScreen.kt")
