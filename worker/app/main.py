...
def _rag_cloud_allowed(req: "ToolChatReq") -> bool:
    ...
    That is pinned by tests/worker_d4_auto_routing.py, which asserts this
    function reads exactly one request attribute and exactly one env flag. Add
    a third and it goes red -- deliberately, so the decision gets faced rather
    than slipped past.
    """
