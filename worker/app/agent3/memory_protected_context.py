    ...
    def compile(
        ...
        *,
        ...
        if selected_target is not ContextTarget.LOCAL:
            raise ProtectedMemoryContextError("protected memory context is local-only")
        ...
        if compiled.target is not ContextTarget.LOCAL:
            raise ProtectedMemoryContextError("protected context renderer changed the target")
