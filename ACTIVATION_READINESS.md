...
**0 af 22 feature-switches er tændt som default.** (14 af posterne nedenfor er indstillinger — tal og stier, ikke beslutninger.)
...
| `KALIV_CONSCIOUSNESS_PROFILE_PATH` | `./consciousness-profile.json` | indstilling |
