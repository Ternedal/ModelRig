# Agent 4 T-034 — health observations and watchdog policy
...
Observation storage, heartbeat ingestion, watchdog execution, checkpoint/pause
composition, operator override and escalation timing are separate slices.
