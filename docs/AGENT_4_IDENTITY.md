...
The A4-06 timeline and A4-07 replay layer are storage/read composition contracts,
not runtime activation. Constructing them starts no thread, timer, scheduler,
network request or Agent 3 work. The timeline creates no directory until an
explicit append, and replay never mutates timeline bytes. Any runtime mount,
recurring ingestion loop, durable consumer offsets, binary evidence vault or
