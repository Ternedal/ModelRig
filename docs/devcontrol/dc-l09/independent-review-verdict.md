...
- the diff contains exactly the 34 allowlisted paths;
...
- the foundation inventory moves only DC-L09 modules to landed status and keeps
  semantic-review, publisher and activation modules forbidden;
