...
Version **0.19.5** — "CI via GitHub Actions". Follows 0.19.4 (V1 release-candidate — still pending Anders' on-device checklist) ("stable signing, conversation persistence, stop button, official icon"). Autonomous session, **2026-07-02/03**.
