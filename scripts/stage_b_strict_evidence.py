#!/usr/bin/env python3
"""Version-bound loader for the retained Stage B strict-evidence gate.

The verified 2.0.12 gate is retained byte-for-byte beside this file. Only the
released source and target version authority is shifted for the current release
era before the retained implementation is executed.
"""
...
if _source.count(_old_source) != 1 or _source.count(_old_target) != 1:
    raise RuntimeError("Stage B strict authority drifted; refusing ambiguous era replacement")
